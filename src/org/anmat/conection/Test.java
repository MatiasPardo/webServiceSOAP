...
//		miAnmat.setEnProduccion(false);
		...
		transaccion1.setgTIN("0898202001013");
		transaccion1.setNroSerial("O14019213-104");
		transaccion1.setNroRemito("R0000-00048140");
		transaccion1.setCuitMedico("23142235609");
		transaccion1.setLote("728");
		transaccion1.setVencimiento("01/04/2023");
		...
		transaccion2.setgTIN("0898202001310");
		transaccion2.setNroSerial("O14019209B-59");
		transaccion2.setNroRemito("R0000-00048140");
		transaccion2.setCuitMedico("23142235609");
		transaccion2.setLote("735");
